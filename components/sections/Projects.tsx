...
const projects = [
  ...
  },
  {
    ...
    name: "BroTest",
    description:
      "This app is for a students who want to take drivers license tests more easy and efficiently. Features include practice tests, progress tracking, and a user-friendly interface. Built with Next.js and Supabase, it provides a seamless experience for learners. A must-have tool for anyone preparing for their driving test.",
